    ...
    <div className="min-h-screen bg-[#07111f] text-slate-100 py-16 px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 text-slate-400 text-xs leading-relaxed">
          ...
          All short-term bridge and CEYS debt structures carry a initial 5-year term with a maximum 24-month extension option subject to underwriting approval and a 1.0% extension fee[cite: 1]. At Year 7 maturity, full exit via property disposition or commercial institutional refinance is required[cite: 1].
        </div>
      </div>
    </div>
  );
