  ...
  return (
    <div className="min-h-screen bg-[#07111f] text-slate-100">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#07111f]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <a className="text-sm text-slate-300 transition hover:text-white" href="#joint-ventures">
              Joint Ventures
            </a>
      ...
      <main id="top">
        ...
        <section id="joint-ventures" className="border-b border-white/10 bg-[#07111f]">
          <JointVentures />
        </section>
